...
const code = (function() { // IIFE, see <https://en.wikipedia.org/wiki/Immediately-invoked_function_expression>

    // Controller für index.html

    // registrieren aller buttons
    document.getElementById("fnDatedown").onclick = function () {
        code.sortFinished("down")
    };
    document.getElementById("fnDateup").onclick = function () {
        code.sortFinished("up")
    };

    document.getElementById("sortCreatedown").onclick = function () {
        code.sortCreate("down")
    };
    document.getElementById("sortCreateup").onclick = function () {
        code.sortCreate("up")
    };

    document.getElementById("sortImportdown").onclick = function () {
        code.sortImportance("down")
    };
    document.getElementById("sortImportup").onclick = function () {
        code.sortImportance("up")
    };
